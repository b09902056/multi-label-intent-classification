...
df_val, df_test = np.split(df_test.sample(frac=1, random_state=42), [int(0.5*len(df_test))])
...
class BertClassifier(nn.Module):
    ...
    def __init__(self, hidden_size, dropout):
        ...
        self.linear = nn.Linear(hidden_size, len(categories_data))
        self.relu = nn.ReLU()
